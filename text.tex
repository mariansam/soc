...
%%% Poděkování
\makethanks{
    Mé poděkování patří v první řadě paní profesorce Mgr. Markétě Wolfové za
    vedení mé práce a podpoře mě i mých spolužáků.

    Dále pak Jakubovi Hamplovi, se kterým jsme celý proces psaní odborné práci
    prošli spolu, Kateřině Michálkové za psychickou podporu, Matějovi Volfovi
    za pomoc s hledáním optimální strategie a celé skupině 0d9e.tech za
...
Tic-Tac-Toe (Udělal jsem lepší piškvorky) jako webové aplikace a analýzu této
